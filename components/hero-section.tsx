...
export function HeroSection() {
  ...
  const downloadCV = () => {
    ...
    link.href = "/cv-malaury-boudon.pdf"
    link.download = "CV-Malaury-Boudon.pdf"
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            <div className="space-y-6">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-balance">
                <span className="text-foreground">{t("hero.creative")}</span>
                <br />
                <span className="text-muted-foreground">{t("hero.developer")}</span>
              </h1>
              ...
              <div className="pt-4">
                <p className="text-sm text-muted-foreground uppercase tracking-wider mb-4">// {t("hero.tagline")}.</p>
              </div>
            </div>
